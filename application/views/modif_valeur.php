...
<head>
    ...
    <link rel="stylesheet" href="<?= theme_url() ?>assets/css/modif_valeur.css">
...
<body>
    <main>
        <div class="main-contenair">
                        ...
                        <div class="popup_items">
                            ...
                            <div class="popup_list_1">
                                <ul>
                                    ...
                                    <li>quantité en stock <span><i class="fa fa-pencil" aria-hidden="true"></i></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="btn">
            ...
            <!-- pop pu modifier les valeurs -->
            <div class="popup2 second">
                <div class="content-popup">
                    <div class="popup_main">
                        <h3>modifier une valeur</h3>
                        <div class="popup_items">
                            <div class="popup_list_2">
                                <ul>
                                    <li>code famille <span><i class="fa fa-pencil" aria-hidden="true"></i></span></li>
                                    <li>folio <span><i class="fa fa-pencil" aria-hidden="true"></i></span></li>
                                    <li>libellé <span><i class="fa fa-pencil" aria-hidden="true"></i></span></li>
                        ...
                        <div class="btn">
                            <span class="details"><a href="#">infomartions détaillées</a></span>
                            <div class="btn-list">
                                <button class="annuler2">annuler</button>
                                <button>valider</button>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?= theme_url() ?>assets/js/modif.js"></script>
</body>
